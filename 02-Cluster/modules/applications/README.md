...
(хотел сделать с помощью провайдеров, но похоже провайдеры не хотят работать с конфигом созданным во время выполнения манифеста [kubernetes](02-Cluster/modules/kubernetes))
...
```
Можно сконфигурировать Runner с помощью файла [runner/values.yaml](02-Cluster/modules/applications/runner/values.yaml)

- Скачивает из GitLab манифест диплома в зависимости от указанного тега
и сохраняет его в [applications/diplom.yaml](02-Cluster/modules/applications/diplom.yaml)
